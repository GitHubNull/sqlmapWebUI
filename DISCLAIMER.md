...
**SQLMap Web UI** 是一款用于 SQL 注入漏洞检测的安全测试工具。本工具仅供合法的安全测试、渗透测试、安全研究和教育目的使用。
...
**SQLMap Web UI** is a security testing tool designed for SQL injection vulnerability detection. This tool is intended solely for legitimate security testing, penetration testing, security research, and educational purposes.
...
如果您发现任何安全漏洞或有任何疑问，请通过 GitHub Issues 联系我们。

If you discover any security vulnerabilities or have any questions, please contact us through GitHub Issues.
