...
import com.sqlmapwebui.burp.ui.dialog.TitleRuleEditDialog;
import com.sqlmapwebui.burp.ui.dialog.TitleTestDialog;
...
public class TitleRulesPanel extends JPanel {
    ...
    private void addRule() {
        ...
        newRule.setName("新规则");
        newRule.setSourceType(com.sqlmapwebui.burp.model.TitleSourceType.URL_PATH);
    ...
    private class RulesTableModel extends AbstractTableModel {
        ...
        private String getSourceTypeDisplayName(com.sqlmapwebui.burp.model.TitleSourceType type) {
            if (type == null) return "";
            switch (type) {
