...
.injection-card {
  ...
  .card-header {
    ...
    border-bottom: 1px solid var(--p-red-300);
...
.technique-item {
  ...
  border: 1px solid color-mix(in srgb, var(--p-yellow-500) 30%, transparent);
  border-radius: 8px;
  padding: 12px;
...
.other-data-card {
  ...
  .card-header {
    ...
    border-bottom: 1px solid color-mix(in srgb, var(--p-green-500) 30%, transparent);
    font-weight: 500;
    font-size: 13px;
