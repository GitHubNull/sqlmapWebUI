...
import com.sqlmapwebui.burp.config.ScanConfig;
import com.sqlmapwebui.burp.config.PresetConfigDatabase;
import com.sqlmapwebui.burp.config.ParseResult;
import com.sqlmapwebui.burp.config.ScanConfigParser;
import com.sqlmapwebui.burp.ui.tab.SqlmapUITab;
import com.sqlmapwebui.burp.ui.component.TextLineNumber;
import com.sqlmapwebui.burp.ui.component.JsonUtils;
import burp.api.montoya.MontoyaApi;
import burp.api.montoya.http.message.HttpRequestResponse;
import burp.api.montoya.http.message.requests.HttpRequest;
import com.sqlmapwebui.burp.ui.panel.GuidedParamEditor;
...
public class AdvancedScanConfigDialog {
    ...
    public AdvancedScanConfigDialog(MontoyaApi api, SqlmapApiClient apiClient,
    ...
    private JPanel createInfoPanel() {
        ...
        if (!textMessages.isEmpty()) {
            String firstUrl = textMessages.get(0).request().url();
    ...
    private void sendNormalScan(ScanConfig config) {
        for (HttpRequestResponse msg : textMessages) {
            sendRequestToBackend(msg.request(), config, null);
        }
    }
     ...
     * 发送请求到后端
     */
    private void sendRequestToBackend(HttpRequest request, ScanConfig config, String markedBody) {
        try {
